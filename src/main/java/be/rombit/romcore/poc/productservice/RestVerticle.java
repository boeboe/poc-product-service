...
import be.rombit.romcore.poc.util.Runner;
...
public class RestVerticle extends AbstractVerticle {
    ...
    private void handleServiceStatus(RoutingContext routingContext) {
        ...
        String name = Manifests.exists("Service-Name") ? Manifests.read("Service-Name") : "poc-product-service";
        String version = Manifests.exists("Service-Version") ? Manifests.read("Service-Version") : "1.0.0";
