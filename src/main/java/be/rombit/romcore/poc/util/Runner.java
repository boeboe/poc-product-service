package be.rombit.romcore.poc.util;
...
public class Runner {
    ...
    public static void runExample(String exampleDir, Class clazz, VertxOptions options, DeploymentOptions
            deploymentOptions) {
        String dir = exampleDir + clazz.getPackage().getName().replace(".", "/");
        runExample(dir, clazz.getName(), options, deploymentOptions);
    }
